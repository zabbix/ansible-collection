    ...
    - hosts: all
      roles:
        - role: zabbix.zabbix.agent
          ...
          agent_param_server: 256.256.256.256                     # address of Zabbix server to accept connections from;
          agent_firewall_allow_from: 256.256.256.256              # address of Zabbix server to allow connections from using firewalld;
  ```
