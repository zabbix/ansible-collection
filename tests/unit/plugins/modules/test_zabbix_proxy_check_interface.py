    ...
    def test_check_interface_param_passive_proxy(self):
        ...
        test_cases = [
            ...
            {   
                ...
                'proxy_mode': '1',
                'default_pname': None,
                'expexted': default_values['proxy_address']},
            {
                'number': 8,
                'input': {'address': ''},
                'param': 'address',
            ...
            {   
                ...
                'proxy_mode': '1',
                'default_pname': 'proxy_dns',
                'expexted': default_values['proxy_dns']},
            {
                'number': 10,
                'input': {'address': ''},
                'param': 'address',
            ...
            {   
                ...
                'proxy_mode': '1',
                'default_pname': None,
                'expexted': default_values['proxy_port']},
            {
                'number': 12,
                'input': {'port': ''},
                'param': 'port',
        ...
        with patch.multiple(
            ...
            for case in test_cases:
                ...
                self.assertEqual(result, case['expexted'])
